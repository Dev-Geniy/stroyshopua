  ...
  const MODULES = [
    {
      ...
      lessons:[
        ...
        {id:"m1l2", title:"Вибір ніші та продукту",              url:"cd/m1l2.html"},
        {id:"m1l3", title:"Перевірка попиту на товар",           url:"cd/m1l3.html"},
        {id:"m1l4", title:"Перший постачальник",                 url:"cd/m1l4.html"},
        {id:"m1l5", title:"Перші продажі без власного сайту",    url:"cd/m1l5.html"}
      ]
    },
    {
      id:"m2",
      ...
      lessons:[
        {id:"m2l1", title:"Як працює модель продажів",           url:"cd/m2l1.html"},
        {id:"m2l2", title:"Маржа, ціни, витрати",                url:"cd/m2l2.html"},
    ...
    },
    {
      ...
      lessons:[
        {id:"m3l1", title:"Підготовка до масової вигрузки",      url:"cd/m3l1.html"},
        {id:"m3l2", title:"Вигрузка великої кількості SKU",      url:"cd/m3l2.html"},
        {id:"m3l3", title:"Вибір прибуткових продуктів",         url:"cd/m3l3.html"},
        {id:"m3l4", title:"Тестування товарів перед масштабом",  url:"cd/m3l4.html"}
      ]
    },
    {
      id:"m4",
    ...
    },
    {
      ...
      lessons:[
        {id:"m5l1", title:"Формати відео, які продають",         url:"cd/m5l1.html"},
        {id:"m5l2", title:"Шаблони контенту для старту",         url:"cd/m5l2.html"},
        {id:"m5l3", title:"Як знімати без сорому",               url:"cd/m5l3.html"},
        {id:"m5l4", title:"Як потрапляти в рекомендації",        url:"cd/m5l4.html"}
      ]
    },
    {
      id:"m6",
      ...
      lessons:[
        {id:"m6l1", title:"Спілкування з клієнтами",             url:"cd/m6l1.html"},
        {id:"m6l2", title:"Повторні продажі та робота з відмовами", url:"cd/m6l2.html"}
      ]
    },
    {
      id:"m7",
      title:"Масштабування",
      lessons:[
        {id:"m7l1", title:"Реклама та бюджети",                  url:"cd/m7l1.html"},
        {id:"m7l2", title:"Система та команда",                  url:"cd/m7l2.html"}
      ]
    }
  ];
